...
alias per="$EDITOR  $QMK_HOME/keyboards/pangaea/rules.mk"
alias perr="$EDITOR $QMK_HOME/keyboards/pangaea/keymaps/default/rules.mk"
...
alias ptar='tar cvfz `date +%Y%m%d-%H%M-pangaea`.tar.gz $PANGAEA_HOME;mv *.tar.gz ~/src/backup'
