...
alias pecfg="vi  $QMK_HOME/keyboards/pangaea/config.h"
...
alias pzip='pcd;cd ../;zip -r pangaea.zip pangaea -x \*/.git/\* keymaps/default/p.h;mv pangaea.zip $HOME/src/;echo "check src"'
####
