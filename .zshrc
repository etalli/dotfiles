...
export QMK_HOME='/Users/k/src/1109/qmk_firmware' # LATEST qmk 22.10
...
alias pcd="cd  $QMK_HOME;echo "";echo QMK_HOME is $QMK_HOME;echo PANGAEA_HOME is $PANGAEA_HOME"
...
alias pc="cd   $QMK_HOME;pwd;/usr/bin/time qmk compile -kb pangaea -km k2"
